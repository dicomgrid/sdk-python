...
class Radreport:
    ...
    def lock(
        ...
        errors_mapping = {}
        errors_mapping[('LOCKED', None)] = Locked('This radreport is locked at the moment by another sid. error_subtype=RADREPORT_LOCKED. error_data={&#34;locked_radreport_id&#34;:radreport_uuid,&#34;locked_user_id&#34;:user_uuid}.')
        errors_mapping[('MISSING_FIELDS', None)] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping[('NOT_FOUND', None)] = NotFound('The radreport  was not found.')
        errors_mapping[('NOT_PERMITTED', None)] = NotPermitted('You are not permitted to lock the radreport')
        query_data = {
            'api': self._api,
            'url': '/radreport/lock',
            'request_data': request_data,
    ...
    def unlock(
        ...
        errors_mapping = {}
        errors_mapping[('ALREADY', None)] = Already('This report is not locked')
        errors_mapping[('LOCKED', None)] = Locked('This radreport is locked at the moment by another user. error_subtype=RADREPORT_LOCKED. error_data={&#34;locked_radreport_id&#34;:radreport_uuid,&#34;locked_user_id&#34;:user_uuid}.')
        errors_mapping[('MISSING_FIELDS', None)] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping[('NOT_FOUND', None)] = NotFound('The radreport  was not found.')
        errors_mapping[('NOT_PERMITTED', None)] = NotPermitted('You are not permitted to lock the radreport')
        query_data = {
