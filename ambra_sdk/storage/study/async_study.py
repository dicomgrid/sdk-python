...
class AsyncStudy(BaseStudy):
    ...
    async def image_json(
        ...
        use_box: bool = True,
        only_prepare: bool = False,
    ) -> Union[ImageJsonBox, ClientResponse, PreparedRequest]:
        ...
        if use_box is True:
            ...
            # But storage does not response encoding.
            response_text = await response.text(encoding='utf-8')
            return ImageJsonBox(json.loads(response_text))
        return response
    ...
    async def json(
        ...
        use_box: bool = True,
        only_prepare: bool = False,
    ) -> Union[JsonBox, ClientResponse, PreparedRequest]:
        ...
        if use_box is True:
            ...
            # But storage does not response encoding.
            response_text = await response.text(encoding='utf-8')
            return JsonBox(json.loads(response_text))
        return response
