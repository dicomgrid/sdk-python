...
"""
from ambra_sdk.exceptions.service import HasAnonymizationProfile
from ambra_sdk.exceptions.service import HasAnonymizationRules
...
class Namespace:
    ...
    def settings(
        ...
        remove_private_tags_on_upload=None,
        ...
        :param remove_private_tags_on_upload: Flag the storage to anonymize or remove all private tags from a study (optional)
...
show_image_on_upload_page (boolean)  Show computer image with CD on upload page when image is uploading to this namespace
        ...
        request_data = {
           ...
           'remove_private_tags_on_upload': remove_private_tags_on_upload,
    ...
    def anonymize(
        ...
        :param uuid: The uuid of the namespace
        :param anonymization_id: The uuid of the anonymization profile to connect to the namespace. (optional)
        ...
        errors_mapping = {}
        errors_mapping[('HAS_ANONYMIZATION_PROFILE', None)] = HasAnonymizationProfile('The namespace has an anonymization profile connected, the anonymization rules cannot be set')
        errors_mapping[('HAS_ANONYMIZATION_RULES', None)] = HasAnonymizationRules('The namespace has anonymization rules set, the namespace cannot be connected to an anonymization profile therefore')
        ...
        errors_mapping[('MISSING_FIELDS', None)] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping[('NOT_FOUND', None)] = NotFound('The namespace or anonymization profile was not found. The error_subtype holds the type of the not found item')
        ...
        errors_mapping[('ONLY_ONE', None)] = OnlyOne('You can pass either the rules parameter with non-empty rule set or non-empty  anonymization_id parameter, but not both')
        query_data = {
            'api': self._api,
