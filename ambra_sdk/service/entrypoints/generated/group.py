...
class Group:
    ...
    def add(
        ...
        errors_mapping[('ROLE_NAMESPACE_MISMATCH', 'INCOMPATIBLE_ROLE')] = RoleNamespaceMismatch('The role cannot be used for a group')
        query_data = {
            'api': self._api,
            'url': '/group/add',
            'request_data': request_data,
    ...
    def set(
        ...
        errors_mapping[('ROLE_NAMESPACE_MISMATCH', 'INCOMPATIBLE_ROLE')] = RoleNamespaceMismatch('The role cannot be used for groups')
        query_data = {
            'api': self._api,
            'url': '/group/set',
            'request_data': request_data,
