...
class Customcode:
    ...
    def add(
        ...
        errors_mapping = {}
        errors_mapping['INVALID_LANGUAGE'] = InvalidLanguage('Invalid language')
        errors_mapping['INVALID_TYPE'] = InvalidType('Invalid type')
        errors_mapping['MISSING_FIELDS'] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping['NOT_HASH'] = NotHash('The field is not a hash')
        errors_mapping['NOT_PERMITTED'] = NotPermitted('You are not permitted to add code')
        query_data = {
            'api': self._api,
            'url': '/customcode/add',
    ...
    def get(
        ...
        errors_mapping = {}
        errors_mapping['MISSING_FIELDS'] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping['NOT_FOUND'] = NotFound('The code can not be found')
        errors_mapping['NOT_PERMITTED'] = NotPermitted('You are not permitted to view this code')
        query_data = {
            'api': self._api,
            'url': '/customcode/get',
            'request_data': request_data,
    ...
    def set(
        ...
        errors_mapping = {}
        errors_mapping['IS_DEPLOYED'] = IsDeployed('The code is deployed and can not be edited')
        errors_mapping['MISSING_FIELDS'] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping['NOT_HASH'] = NotHash('The field is not a hash')
        errors_mapping['NOT_PERMITTED'] = NotPermitted('You are not permitted to edit the code')
        errors_mapping['ONE_ZIP_ONLY'] = OneZipOnly('Only one code with an attached zip can be deployed to the namespace')
        query_data = {
            'api': self._api,
            'url': '/customcode/set',
            'request_data': request_data,
    ...
    def delete(
        ...
        errors_mapping = {}
        errors_mapping['IS_DEPLOYED'] = IsDeployed('The code is deployed and can not be deleted')
        errors_mapping['MISSING_FIELDS'] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping['NOT_PERMITTED'] = NotPermitted('You are not permitted to delete the code')
        query_data = {
            'api': self._api,
    ...
    def list(
        ...
        errors_mapping['NOT_PERMITTED'] = NotPermitted('You are not permitted to view code in this account')
        query_data = {
            'api': self._api,
            'url': '/customcode/list',
            'request_data': request_data,
    ...
    def deploy(
        ...
        errors_mapping = {}
        errors_mapping['ALREADY'] = Already('The code is already deployed for this namespace')
        errors_mapping['MISSING_FIELDS'] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping['NOT_FOUND'] = NotFound('The namespace or customcode can not be found')
        errors_mapping['NOT_PERMITTED'] = NotPermitted('You are not permitted to deploy code in this namespace')
        query_data = {
            'api': self._api,
    ...
    def undeploy(
        ...
        errors_mapping = {}
        errors_mapping['MISSING_FIELDS'] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping['NOT_FOUND'] = NotFound('The deployment can not be found')
        errors_mapping['NOT_PERMITTED'] = NotPermitted('You are not permitted to undeploy code in this namespace')
        query_data = {
            'api': self._api,
    ...
    def deploy_get(
        ...
        errors_mapping = {}
        errors_mapping['MISSING_FIELDS'] = MissingFields('A required field is missing or does not have data in it. The error_subtype holds a array of all the missing fields')
        errors_mapping['NOT_FOUND'] = NotFound('The customcode deployment can not be found')
